...
//                     <td className="border border-gray-200 px-3 py-2 text-center">
//                       {/* ✅ Case 1: Already pinned */}
//                       {req.pinnedNumber ? (
//                         (() => {
//                           const pinnedObj = availableNumbers.find(
//                             (n) => n.id === req.pinnedNumber?.id
//                           );

//                           const isPurchased = pinnedObj?.isPurchased === true;

//                           return (
//                             <button
//                               onClick={() => {
//                                 if (isPurchased) {
//                                   alert("This number is already purchased.");
//                                   return;
//                                 }
...
//                       ) : (
//                         <>
//                           {/* ✅ Case 2: Not pinned yet -> No Pin button initially */}
//                           {selectedNumbers[req.id] ? (
//                             (() => {
//                               const selectedObj = availableNumbers.find(
//                                 (n) => n.id === selectedNumbers[req.id]
//                               );

//                               const isPurchased = selectedObj?.isPurchased === true;
...
//                             })()
//                           ) : (
//                             <span className="text-xs text-gray-400">Select a number</span>
//                           )}
//                         </>
//                       )}
//                     </td>
