...
// import { updateProfileSettings } from "@/app/api/profile-settings/profile-settings";
...
//     try {
//       const res = await updateProfileSettings(payload, token);
...
//       <Image src={auth.user.image} alt={auth.user.name} width={96} height={96} />
...
const ProfileContainerPage = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6">
      <div className="mb-8">
        <ImageUpload currentImage={auth.user?.image} onImageChange={handleImageChange} className="mb-6" />
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid md:grid-cols-3 grid-cols-1 gap-4 mb-4">
          ...
          <FormField
            ...
            placeholder="Write Service Name"
            value={formData.serviceName}
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleChange("serviceName", e.target.value)}
          />
          <FormField
            label="Phone Number"
            name="phoneNumber"
        ...
        <div className="grid grid-cols-1 gap-4 mb-6">
          <FormField
            ...
            placeholder="Write Your Address"
            value={formData.serviceAddress}
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleChange("serviceAddress", e.target.value)}
          />
        </div>
