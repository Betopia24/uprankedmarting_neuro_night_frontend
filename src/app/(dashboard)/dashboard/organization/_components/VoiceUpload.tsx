      ...
      >
        <div className="max-w-md">
          ...
          <p className="text-lg text-gray-700 mb-6">
            Your current plan does not allow uploading documents for Voice
            Upload
          </p>
