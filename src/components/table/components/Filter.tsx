    ...
    <div className="bg-white border border-gray-200 rounded-lg p-4 mb-4">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
        <div className="flex items-center gap-2">
          ...
          {hasActiveFilters && (
            <span className="bg-gray-100 text-blue-800 text-xs px-2 py-1 rounded-full">
                ...
                return displayValues.map((val) => {
                  ...
                  return (
                    <Link
                      ...
                      className="inline-flex items-center gap-1 px-2 py-1 bg-gray-100 text-blue-800 text-xs rounded-full hover:bg-blue-200 transition-colors"
                    >
    ...
    <div className="relative group">
      ...
      <button
        className={cn(
          ...
          selectedCount > 0 && "border-blue-300 bg-gray-50"
        )}
      >
        <span
          className={cn(
                ...
                return (
                  <Link
                    ...
                    className={cn(
                      ...
                      isSelected ? "bg-gray-50 text-blue-700" : "text-gray-700"
                    )}
                  >
                    <div
                      className={cn(
