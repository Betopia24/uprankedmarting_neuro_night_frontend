          ...
          <div className="bg-warning space-y-4 flex-1 p-6 text-[20px]">
            ...
            <div className="text-base leading-relaxed space-y-2">
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>
                  Smart Lead Qualification: Screen and prioritize leads based on
                  your unique needs.
                </li>
                <li>
                ...
                <li>
                  Seamless Integrations: Connect with over 5,000 apps, including
                  HubSpot, Salesforce, Slack, and Zapier.
                </li>
                <li>
                ...
                <li>
                  Bilingual Support: Serve customers in English and Spanish with
                  ease.
                </li>
                <li>
