              ...
              <div className="bg-warning space-y-4 flex-1 p-6 text-[20px]">
                ...
                <div className="text-base leading-relaxed space-y-2">
                  <ul className="list-disc list-inside space-y-2">
                    <li>
                      24/7 Call Handling: Answer every call, day or night, with
                      AI or live receptionists.
                    </li>
                    <li>
                      Smart Lead Qualification: Screen and prioritize leads
                    ...
                    <li>
                      Custom AI Responses: Train your AI to answer FAQs or
                      handle complex queries with your brand’s voice.
                    </li>
                    <li>
